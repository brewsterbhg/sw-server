...
parcelRequire = (function(modules, cache, entry, globalName) {
      ...
      function(require, module, exports) {
        ...
        async function initDB() {
          ...
          db = await (0, _idb.openDB)(DB_NAME, VERSION, {
            upgrade(db) {
              _schema.schema.forEach(async store => {
        ...
        async function createNewStore(store) {
          db = await (0, _idb.openDB)(DB_NAME, VERSION, {
            async upgrade(db) {
              await createStore(db, store);
            },
        ...
        async function find(storeName, key) {
          return await db
  ...
  {},
  ['node_modules/parcel-bundler/src/builtins/hmr-runtime.js', 'src/api.js'],
  null,
);
