...
parcelRequire = (function(modules, cache, entry, globalName) {
    ...
    'src/db.js': [
      function(require, module, exports) {
        ...
        async function seed() {
          ...
          db = await (0, _idb.openDB)(DB_NAME, VERSION, {
            upgrade(db) {
              _schema.schema.forEach(
                async store => await createStore(db, store),
              );
            },
          });

          _schema.schema.forEach(({ storeName, data }) =>
            data.forEach(async item => await add(storeName, item)),
          );
        }
        /**
         *
        ...
        /**
         * Prepare an IndexedBD transaction
         *
         * @param {string} storeName
         */
  ...
  {},
  ['node_modules/parcel-bundler/src/builtins/hmr-runtime.js', 'src/db.js'],
  null,
);
//# sourceMappingURL=/db.1b531414.js.map
